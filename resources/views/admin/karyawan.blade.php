...
<a href="{{url('login/google')}}"><button class="btn btn-success btn-lg fa fa-search" type="button"
    style="margin-bottom: 20px;">
    Cari Email Karyawan
  </button></a>

@if(!empty($email))
<button class="btn btn-success btn-lg fa fa-plus" type="button" data-toggle="modal" data-mynama="{{$name}}"
  data-myemail="{{$email}}" data-myava="{{$ava}}" data-target="#AddKaryawan" style="margin-bottom: 20px;">
  Tambah
</button>
@else
<button class="btn btn-success btn-lg fa fa-plus" type="button" data-toggle="modal" data-target="#kosong"
  style="margin-bottom: 20px;">
  Tambah
</button>
@endif
