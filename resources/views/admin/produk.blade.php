...
<button class="btn btn-success btn-lg fa fa-plus" type="button" data-toggle="modal" data-target="#myModal"
    ...
    <table class="table table-bordered" id="hidden-table-info">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-success" data-mynama="{{ $dt->nama_produk }}"
              data-mysize="{{ $dt->size }}" data-myid="{{ $dt->id }}" data-myharga="{{ $dt->harga }}"
              data-mystok="{{ $dt->stok }}" data-myimg="{{ $dt->gambar }}" data-toggle="modal" data-target="#edit"><i
                class="fa fa-edit"></i> Ubah</button>
            <button type="button" data-myid="{{ $dt->id }}" class="btn btn-danger" data-toggle="modal"
              data-target="#delete-produk"><i class="fa fa-trash"></i>Hapus</button>
        </tr>
        @endforeach
        @else
        <td colspan="8">
